...
def place_was_visited(request, place_pk):
    ...
    if request.method == 'POST':
        ...
        if place.user == request.user: # only lset a user visit their own places
            place.visited = True
            place.save()
        else:
...
def place_details(request, place_pk):
    ...
    #Checks to make sure the user who owns this place is the one editing it
    #Does this place belong to the current use
